...
import styles from '../styles/DMPCCard.module.css'
    ...
    <div>
      <div className="bg-[#171717] w-fit h-fit p-4 rounded-lg shadow-md shadow-[#373636]">
        ...
        <p className="text-xl font-semibold text-gray-500 py-2">
          Enable Dank Memer premium cooldowns for yourself to get reminders
          which use premium cooldowns
        </p>
